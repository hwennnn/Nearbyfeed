...
export const LocationCard = ({ location, isFullView = false }: Props) => {
  ...
  return (
    <View className="mt-3 flex-1 space-y-2">
      {isFullView && (
      ...
      >
        ...
        <View className="flex-col">
          ...
          <Text
            className="pr-8 text-gray-600 dark:text-gray-300"
            variant="sm"
            numberOfLines={isFullView ? undefined : 1}
          >
            {formattedAddress}
          </Text>
        </View>
